...
export default function Contact() {
    return (<>
        ...
        <main className="min-h-screen bg-black text-white selection:bg-red-500 selection:text-black overflow-hidden relative flex flex-col"><section className="flex-1 flex items-center justify-center relative z-10 pt-20">
